...
\section{Simple simulation example}
...
\subsection{Organize the parameter vector}
...
\subsection{Construct the deviance function}
...
\subsection{Optimize the deviance function}
...
\section{A simple phylogenetic example}
